...
void draw_cone(int height,int r,int seq)
{
    ...
    for(int i=0; i<seq; i++)
    {
        int x=r*cos((2*3.14159*i)/seg);
        int y=r*sin((2*3.14159*i)/seg);
        int h=height;
        int pix1=color_fix[i%3].x;
        int pix2=color_fix[i%3].y;
        int pix3=color_fix[i%3].z;
